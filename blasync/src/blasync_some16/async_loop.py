...
"""Manages the asyncio loop. (Copied from https://github.com/lampysprites/blender-asyncio with no changes which was copied from Blender Cloud plugin with minor changes)"""
